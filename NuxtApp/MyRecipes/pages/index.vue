<template>
    <div>
        ...
        Please log in to get credentials to visit secret page "Recipes"
    ...
    export default {
        ...
        methods: {
            async onSubmit () {
                ...
                try {
                  var res = null;
                    //weil es keine lokale datenhaltung gibt atm dieser workaround
                    if(credentials.email === 'bob' && credentials.password ==='bob'){
                      res = { token: 'apollo-token', id: 0}
                    }else{
