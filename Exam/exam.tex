...
\question CSS
\missingfigure{Some HTML to select elements from}
\begin{parts}
\part[3]
  Which element(s) are selected with this CSS selector?
  \todo[inline]{Three different CSS selectors here}
\part[1]
  Write down a CSS selector to select all input fields in the above example
